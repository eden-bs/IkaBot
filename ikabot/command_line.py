...
from ikabot.function.allianceAttackAlert import allianceAttackAlert
...
def menu(session, checkUpdate=True):
    ...
    print(_("(22) Alliance attack alert"))
...
def main():
    ...
    try:
        ...
        print("YAIRRRRRRRRRRRRRRRRRRRRRRRRRRRRR ZE TEST YA MANYAK")
        clear()
